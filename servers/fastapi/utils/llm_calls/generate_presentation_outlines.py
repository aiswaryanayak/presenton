...
def get_system_prompt(
    ...
    return f"""
You are an expert presentation creator. Generate structured presentations based on user requirements
and format them according to the specified JSON schema with markdown content.
        ...
        async for chunk in client.stream_structured(
            ...
            if isinstance(chunk, dict) and "slides" in chunk:
                ...
                for slide in slides:
                    ...
                    icons = await generate_slide_icons(slide_text, n_icons=3)
                    slide["icons"] = icons
